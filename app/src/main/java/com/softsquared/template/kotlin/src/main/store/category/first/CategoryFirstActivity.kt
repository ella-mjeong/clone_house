...
import com.softsquared.template.kotlin.databinding.ActivityCategoryFirstBinding
...
class CategoryFirstActivity : BaseActivity<ActivityCategoryFirstBinding>(ActivityCategoryFirstBinding::inflate),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.categoryFirstTitle.text = intent.getStringExtra("cate1")
        category = intent.getStringExtra("cate1").toString()
        ...
        val fragmentList = listOf(
            BannerCategoryActivity(R.drawable.cate1_b1), BannerCategoryActivity(
                R.drawable.cate1_b2), BannerCategoryActivity(R.drawable.cate1_b3)
        )
        val adapter = PopularBannerAdapter(this)
        ...
        if(response.code == 1000) {
            ...
            for(i in 0 until listSize){
                if(myProductList[i].specialPrice == null){
                    myListArrayList.add(
                        ProductListInfo(myProductList[i].image,myProductList[i].displayName,myProductList[i].price,
